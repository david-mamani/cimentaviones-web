...
def _case_I(B: float, L: float, e1: float, e2: float) -> dict:
    ...
    L1 = L * (1.5 - 3.0 * e1 / L)
    if B1 <= 0 or L1 <= 0:
        # Por la validación previa esto no debería pasar, pero defensivo.
        raise ValueError(
...
# ───────────────────────────────────────────────────────────────
# Casos II, III, IV — stubs bloqueados por digitalización de ábacos
# ───────────────────────────────────────────────────────────────
...
def compute_effective_dimensions_ha(
    B: float, L: float, e1: float, e2: float,
) -> dict:
    """
...
# Cuando lleguen los datos digitalizados, completar estas estructuras:
#
#   HA_CASE_II_TABLE  = {"eL_L": [...], "eB_B": [...], "L1_over_L": [[...]],
#                        "L2_over_L": [[...]]}
#   HA_CASE_III_TABLE = {"eL_L": [...], "eB_B": [...], "B1_over_B": [[...]],
#                        "B2_over_B": [[...]]}
#   HA_CASE_IV_TABLE  = {"eL_L": [...], "eB_B": [...], "B2_over_B": [[...]],
#                        "L2_over_L": [[...]]}
#
# Con interpolación bilineal sobre la malla (eL/L, eB/B). Patrón: ver `FOX_TABLE`
# en `calculos/settlement.py`.
