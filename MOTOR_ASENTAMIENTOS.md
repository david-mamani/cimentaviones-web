...
### 6.2 Tabla Fox digitalizada (Das 9ed Fig. 9.6 "Effect of Embedment")

Re-leída directamente del libro (5 curvas × 9 valores de Df/B × 3 paneles
L/B = 135 puntos). Precisión esperada: ±0.02 por lectura humana.

**Panel (a) — L/B = 1**

| Df/B | μ=0.0 | μ=0.1 | μ=0.3 | μ=0.4 | μ=0.5 |
|:---:|:---:|:---:|:---:|:---:|:---:|
| 0.00 | 1.00 | 1.00 | 1.00 | 1.00 | 1.00 |
| 0.25 | 0.79 | 0.81 | 0.86 | 0.89 | 0.91 |
| 0.50 | 0.69 | 0.72 | 0.77 | 0.81 | 0.84 |
| 0.75 | 0.62 | 0.65 | 0.71 | 0.75 | 0.79 |
| 1.00 | 0.56 | 0.59 | 0.65 | 0.70 | 0.74 |
| 1.25 | 0.53 | 0.55 | 0.61 | 0.66 | 0.70 |
| 1.50 | 0.50 | 0.52 | 0.58 | 0.63 | 0.67 |
| 1.75 | 0.47 | 0.49 | 0.55 | 0.60 | 0.65 |
| 2.00 | 0.45 | 0.47 | 0.53 | 0.58 | 0.63 |
...
|:---:|:---:|:---:|:---:|:---:|:---:|
| 0.00 | 1.00 | 1.00 | 1.00 | 1.00 | 1.00 |
| 0.25 | 0.85 | 0.87 | 0.90 | 0.92 | 0.94 |
| 0.50 | 0.75 | 0.78 | 0.83 | 0.86 | 0.89 |
| 0.75 | 0.69 | 0.71 | 0.77 | 0.80 | 0.84 |
| 1.00 | 0.63 | 0.66 | 0.72 | 0.76 | 0.79 |
| 1.25 | 0.59 | 0.62 | 0.68 | 0.72 | 0.76 |
| 1.50 | 0.56 | 0.59 | 0.65 | 0.69 | 0.73 |
| 1.75 | 0.53 | 0.56 | 0.62 | 0.66 | 0.70 |
| 2.00 | 0.51 | 0.53 | 0.59 | 0.64 | 0.68 |
...
|:---:|:---:|:---:|:---:|:---:|:---:|
| 0.00 | 1.00 | 1.00 | 1.00 | 1.00 | 1.00 |
| 0.25 | 0.89 | 0.91 | 0.93 | 0.95 | 0.97 |
| 0.50 | 0.81 | 0.83 | 0.87 | 0.90 | 0.92 |
| 0.75 | 0.75 | 0.77 | 0.82 | 0.85 | 0.88 |
| 1.00 | 0.69 | 0.71 | 0.77 | 0.81 | 0.84 |
| 1.25 | 0.65 | 0.68 | 0.74 | 0.78 | 0.81 |
| 1.50 | 0.62 | 0.64 | 0.71 | 0.75 | 0.78 |
| 1.75 | 0.59 | 0.61 | 0.68 | 0.72 | 0.75 |
| 2.00 | 0.56 | 0.58 | 0.65 | 0.69 | 0.73 |

### 6.3 Implementación

1. Interpolación lineal en `Df/B` (9 puntos: 0.00, 0.25, ..., 2.00).
2. Interpolación lineal en `μ` (5 puntos: 0.0, 0.1, 0.3, 0.4, 0.5).
3. Interpolación lineal en `L/B` (3 puntos: 1, 2, 5).
4. **Clamping**:
   - `Df/B > 2` → congelar a `Df/B = 2` (warning emitido).
   - `L/B > 5` → congelar a `L/B = 5` (warning).
   - `μ` se limita al rango [0.0, 0.5] (saturados arriba/abajo).
5. `L/B ≥ 1` siempre (convención B ≤ L).
6. **Invariantes verificadas por tests**:
   - Df/B = 0 ⇒ If = 1 para cualquier (L/B, μ).
   - If creciente con L/B (a mismo Df/B, μ).
   - If creciente con μ (a mismo Df/B, L/B).
   - If decreciente con Df/B (a mismo L/B, μ).
